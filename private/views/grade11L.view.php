...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 11 L DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade11L_row) || is_object($grade11L_row)): ?>
			<?php foreach ($grade11L_row as $grade11l): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade11l->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade11l->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade11l->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11l->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11l->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11l->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
