...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 1 Religion Term 3
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade1_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade1_religionT1/updateTableT3" method="post">
                ...
                <?php if(is_array($grade1s) || is_object($grade1s)) : ?>
                    <?php foreach ($grade1s as $grade1) : ?>
                        <tr>
                            ...
                            <td><button onclick="calculateAllSums()" class="btn-sm btn btn-info text-white"><i class="fa-solid fa-calculator"></i></button></td>
                        </tr>
            ...
            <a href="<?= ROOT ?>/Subjects_grade1" class="btn btn-danger">Back</a>
        </form>
