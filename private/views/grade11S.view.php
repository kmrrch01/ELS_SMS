...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 11 S DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade11S_row) || is_object($grade11S_row)): ?>
			<?php foreach ($grade11S_row as $grade11s): ?>
				<tr>
                    <td>
                    ...
                    <td>
                        <p style="text-align:center;"><?=$grade11s->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade11s->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11s->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11s->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade11s->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
