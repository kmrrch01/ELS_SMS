  ...
  <?php if(count($errors) > 0):?>
    ...
    <div class="row jumbotron box8">
      <div class="col-sm-12 mx-t3 mb-4">
        <h2 class="text-center text-primary">Update Payment Fees</h2>
      </div>
      
      <div class="col-sm-6 form-group">
        <label for="name-f">Full Name[EN]</label>    
            <input class="my-2 form-control" value="<?=get_var('fullname',$row[0]->fullname)?>"
            type="firstname" name="fullname" id="fullname" placeholder="Full Name" autofocus></input>
    </div>

    <div class="col-sm-6 form-group">
        <label for="name-f">Full Name[AR]</label>    
            <input class="my-2 form-control"  value="<?=get_var('fullname_ar',$row[0]->fullname_ar)?>"
      ...
      <div class="col-sm-6 form-group">
        <label for="Position">Position</label>
            ...
            <input class="my-2 form-control" value="<?=get_var('position',$row[0]->position)?>"
      ...
      <div class="col-sm-6 form-group">
        <label for="acad_year">Academic Year</label>
            ...
            <input class="my-2 form-control" value="<?=get_var('academic_year',$row[0]->academic_year)?>"
      ...
      <div class="col-sm-6 form-group">
        ...
        <input class="my-2 form-control"  value="<?=get_var('Remain_in_Dollar',$row[0]->Remain_in_Dollar)?>" type="text" id="Fees_in_Dollar" name="Fees_in_Dollar" oninput="calculateSum()" placeholder="$" autofocus></input>
      </div>
      <div class="col-sm-6 form-group">
        <label for="name-f">Fees in lebanese lira</label>
        <input class="my-2 form-control" value="<?=get_var('Remain_in_lebanese',$row[0]->Remain_in_lebanese)?>" type="text" id="Fees_in_lebanese" name="Fees_in_lebanese" placeholder="L.L." oninput="calculateSum1()" autofocus></input>
      </div>
      <div class="col-sm-6 form-group">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input class="my-2 form-control" value="<?=get_var('Remain_in_Dollar')?>" type="text" id="Remain_in_lebanese" name="Remain_in_lebanese"  placeholder="...." autofocus></input>
        
      </div>
    
        <center><button style="margin-left:20%;" class="fs-1 btn btn-primary">Update</button></center>
