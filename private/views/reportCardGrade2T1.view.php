...
<body style="max-width:2480px; max-height:3508px; margin-left:100px;">
        ...
        <?php foreach ($grade2s_arT1 as $key => $grade2_arT1) : ?>
            <?php $grade2_mathT1 = $grade2s_mathT1[$key] ?? null; ?>
            <?php $grade2_enT1 = $grade2s_enT1[$key] ?? null; ?>
            <?php $grade2_scT1 = $grade2s_scT1[$key] ?? null; ?>
            <?php $grade2_relT1 = $grade2s_relT1[$key] ?? null; ?>
            <div style="margin-top: 100px;" id="rcardtitle">

                <h3 style="text-align:center;margin-bottom:20px"class="display-5">Student Report Card - <?= strtoupper($grade2_arT1->fullname)?></h3>
            </div>
            <table class="table striped-hover content">
                ...
                <th>
                    ...
                    <tr>
                        <td>ARABIC</td>
                        <td>100</td>
                        <td id="arHomework"><?= $grade2_arT1->homework ?></td>
                        <td id="arQuiz"><?= $grade2_arT1->quiz ?></td>
                        <td id="arTest"><?= $grade2_arT1->test ?></td>
                        <td id="arAvg"></td>
                    ...
                    <tr>
                        <td>ENGLISH</td>
                        <td>100</td>
                        <td id="enHomework"><?= $grade2_enT1->homework ?></td>
                        <td id="enQuiz"><?= $grade2_enT1->quiz ?></td>
                        <td id="enTest"><?= $grade2_enT1->test ?></td>
                        <td id="enAvg"></td>
                    </tr>
                    ...
                    <tr>
                        <td>MATH</td>
                        <td>100</td>
                        <td id="mathHomework"><?= $grade2_mathT1->homework ?></td>
                        <td id="mathQuiz"><?= $grade2_mathT1->quiz ?></td>
                        <td id="mathTest"><?= $grade2_mathT1->test ?></td>
                        <td id="mathAvg"></td>
                    </tr>
                    ...
                    <tr>
                        <td>SCIENCE</td>
                        <td>100</td>
                        <td id="scHomework"><?= $grade2_scT1->homework ?></td>
                        <td id="scQuiz"><?= $grade2_scT1->quiz ?></td>
                        <td id="scTest"><?= $grade2_scT1->test ?></td>
                        <td id="scAvg"></td>
                    </tr>
                    ...
                    <tr>
                        <td>RELIGION</td>
                        <td>100</td>
                        <td id="relHomework"><?= $grade2_relT1->homework ?></td>
                        <td id="relQuiz"><?= $grade2_relT1->quiz ?></td>
                        <td id="relTest"><?= $grade2_relT1->test ?></td>
                        <td id="relAvg"></td>
                    </tr>
