	...
	<div class="justify-content-center container-fluid p-6 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="row">
				<table class="table table-hover table-striped table-bordered">
					...
					<tr><th>Class Name:</th><td><?=str_replace("_", " ", ucwords(esc($row->class_name)))?></td></tr>
		...
		<div style="padding-left:15%;" class="m-2 justify-content-center container-fluid">
			<ul class="nav nav-tabs">
			  <li class="nav-item">
			    <a class="nav-link <?=$page_tab=='teacher'?'active':'';?> " href="<?=ROOT?>/single_class/<?=$row->class_id?>?tab=teachers ">Teachers</a>
			  </li>
			  <li class="nav-item">
