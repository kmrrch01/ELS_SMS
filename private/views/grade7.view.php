...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 7 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade7s) || is_object($grade7s)): ?>
			<?php foreach ($grade7s as $grade7): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade7->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade7->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade7->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade7->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade7->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade7->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
