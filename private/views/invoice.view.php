      ...
      <form method="post">
        ...
        <div class="row jumbotron box8">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input class="my-2 form-control" value="<?= get_var('fullname') ?>" type="firstname" name="fullname" id="fullname" placeholder="Full Name" autofocus></input>
          </div>

          <div class="col-sm-6 form-group">
            <label for="name-f">Full Name[AR]</label>
            <input class="my-2 form-control" value="<?= get_var('fullname_ar') ?>" type="fullname_ar" name="fullname_ar" id="fullname_ar" placeholder="fullname_ar" autofocus></input>
          </div>
          ...
          <div class="col-sm-6 form-group">
            ...
            <input class="my-2 form-control" value="<?= get_var('academic_year') ?>" type="academic_year" name="academic_year" id="academic_year" placeholder="academic_year" autofocus></input>
          </div>
          <div class="col-sm-6 form-group">
            <label for="parent_id">Parent</label>
            <select name="parent_id" id="parent_id" class="form-control browser-default custom-select">
              <option value="">Please select a parent</option>
              <?php if (is_array($parents) || is_object($parents)) : ?>
                <?php foreach ($parents as $parent) : ?>
                  <option value="<?= $parent->user_id ?>" <?= get_select('parent_id', $parent->user_id) ?>>
                    <?= $parent->user_id ?> | <?= $parent->firstname ?> <?= $parent->lastname ?>
                  </option>
          ...
          <a href="<?= ROOT ?>/Fees_billing">
            <input style="margin-left:30%;" class="btn btn-danger" type="button" value="Back">
          </a>
