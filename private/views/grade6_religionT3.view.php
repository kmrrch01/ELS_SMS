...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 6 Religion Term 3
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade6_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade6_religionT1/updateTable3" method="post">
            ...
            <a href="<?= ROOT ?>/Subjects_grade6" class="btn btn-danger">Back</a>
        </form>
