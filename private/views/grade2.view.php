...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 2 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade2s) || is_object($grade2s)): ?>
			<?php foreach ($grade2s as $grade2): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade2->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade2->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade2->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade2->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade2->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade2->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
