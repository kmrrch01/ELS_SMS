...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 5 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade5s) || is_object($grade5s)): ?>
			<?php foreach ($grade5s as $grade5): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade5->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade5->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade5->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade5->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade5->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade5->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
