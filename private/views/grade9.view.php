...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 9 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade9s) || is_object($grade9s)): ?>
			<?php foreach ($grade9s as $grade9): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade9->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade9->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade9->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade9->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade9->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade9->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
