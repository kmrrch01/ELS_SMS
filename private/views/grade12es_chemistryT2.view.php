...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 12es Chemistry Term 2
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade12es_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade12es_chemistryT1/updateTable2" method="post">
            ...
            <a href="<?= ROOT ?>/Subjects_grade12es" class="btn btn-danger">Back</a>
        </form>
