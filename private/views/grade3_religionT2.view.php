...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 3 Religion Term 2
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade3_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade3_religionT1/updateTable2" method="post">
            ...
            <a href="<?= ROOT ?>/Subjects_grade3" class="btn btn-danger">Back</a>
        </form>
