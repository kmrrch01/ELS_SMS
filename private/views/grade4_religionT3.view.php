...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 4 Religion Term 3
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade4_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade4_religionT1/updateTable3" method="post">
            ...
            <a href="<?= ROOT ?>/Subjects_grade4" class="btn btn-danger">Back</a>
        </form>
