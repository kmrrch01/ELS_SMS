...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 8 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade8s) || is_object($grade8s)): ?>
			<?php foreach ($grade8s as $grade8): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade8->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade8->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade8->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade8->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade8->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade8->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
