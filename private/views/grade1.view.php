...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 1 DETAILS <i class="fa fa-book"></i></h1>
			...
			<?php foreach ($grade1s as $grade1): ?>
				<tr>
                    <td>
                        ...
                        <a href="<?=ROOT?>/stp/<?=$grade1->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade1->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade1->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade1->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade1->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade1->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
