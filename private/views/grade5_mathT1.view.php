...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 5 Math Term 1
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade5_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade5_mathT1/updateTable" method="post">
            <table class="table table-striped" id="myTable">
                ...
                <tbody>
                    ...
                    <?php endforeach; ?>
                    <?php else:?>
                        <h1>No students were found at this time</h1>
                    <?php endif;?>

                    </body>
            </table><br>
            <button type="submit" class="btn btn-primary">Update</button>
            <a href="<?= ROOT ?>/Subjects_grade5" class="btn btn-danger">Back</a>
        </form>
