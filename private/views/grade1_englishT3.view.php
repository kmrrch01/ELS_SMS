...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 1 English Term 3
    ...
    <a href="">
        ...
        <form action="<?= ROOT ?>/Grade1_englishT1/updateTableT3" method="post">
                ...
                <?php if(is_array($grade1s) || is_object($grade1s)) : ?>
                    <?php foreach ($grade1s as $grade1) : ?>
                        <tr>
                            ...
                            <td><button onclick="calculateAllSums()" class="btn-sm btn btn-info text-white"><i class="fa-solid fa-calculator"></i></i></button></td>
                        </tr>
