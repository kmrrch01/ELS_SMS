...
<h1 style="text-align:center;font-family: copperplate;" class="breadcrumb justify-content-center">
				GRADE 6 DETAILS <i class="fa fa-book"></i></h1>
            ...
            <br><br>
			<?php if (is_array($grade6s) || is_object($grade6s)): ?>
			<?php foreach ($grade6s as $grade6): ?>
				<tr>
                    <td>
                        <div style="text-align:center;">
                        <a href="<?=ROOT?>/stp/<?=$grade6->student_id?>">
                            <button class="btn-outline-primary"><i class="fa-solid fa-user-graduate"></i>
                    </a>
            </div>
                    </td>
                    <td>
                        <p style="text-align:center;"><?=$grade6->fullname?>
                    </td>

                    <td>
                        <div style="text-align:center;"><?=$grade6->student_id?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade6->section?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade6->st_type?></div>
                    </td>
                    <td>
                        <div style="text-align:center;"><?=$grade6->acad_year?></div>
                    </td>
				</tr>
			<?php endforeach; ?>
		<?php else: ?>
