...
<div class="container">
    <div style="padding-left:100px;">
        <h1 style="font-family: copperplate;" class="breadcrumb justify-content-center">
            STUDENT EVALUTAION - GRADE 2 Math Term 1
    ...
    <a href="">
        ...
        <a href="<?= ROOT ?>/Grade2_arabicT1/excel">
            <button class="btn btn-success"><i class="fa-solid fa-file-import"></i></button>
        </a>
        <form action="<?= ROOT ?>/Grade2_mathT1/updateTable" method="post">
            ...
            <table class="table table-striped" id="myTable">
                ...
                <tbody>
        <?php if(is_object($grade1s) || is_array($grade1s)):?>
                    ...
                    <?php else:?>
                        <h5 style="font-style:italic;text-align:center;">Oh no! This class is empty!</h5>
                    <?php endif;?>
            </table>
            <button type="submit" class="btn btn-primary">Update</button>
            <a href="<?= ROOT ?>/Subjects_grade2" class="btn btn-danger">Back</a>
        </form>
