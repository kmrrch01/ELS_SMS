					...
					<tr>
						<td>
							<a href="<?= ROOT ?>/<?= str_replace("_", "", $row->class) ?>">
								<button class="btn btn-sm btn-primary"><i class="fa-solid fa-book"></i></button>
						</td>
						</a>
						<td><a href="<?= ROOT ?>/Subjects_<?= strtolower(str_replace('_', '', $row->class)) ?>">
								<button class="btn-sm btn btn-info text-white"><i class="fa-solid fa-book-medical"></i></button>
							</a></td>


						<!--<td><a href="<?= ROOT ?>/<?= str_replace("_", "", $row->class) . "_" . "table" ?>">
						...
						<td>
							...
							<a href="<?= ROOT ?>/ReportCardT1_<?=str_replace("_", "",$row->class)?>">
								<button class="btn-sm btn btn-success"><i class="fa-solid fa-scroll"></i></button>
							</a>
