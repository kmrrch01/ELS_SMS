 ...
 * classes controller
 */
class ReportCard_grade10 extends Controller
{
	...
	public function index()
	{
		...
		$grade1s_ar = new Grade_10_arabicT1();
		$grade1s_en = new Grade_10_englishT1();
		$grade1s_bi = new Grade_10_biologyT1();
		$grade1s_hi = new Grade_10_historyT1();
		$grade1s_ma = new Grade_10_mathT1();
		$grade1s_ph = new Grade_10_physicsT1();
		$grade1s_ch = new Grade_10_chemistryT1();
        $grade1s_ge = new Grade_10_geoT1();
		$grade1s_ci = new Grade_10_civT1();
        $grade1s_ec = new Grade_10_ecoT1();
		$grade1s_so = new Grade_10_socioT1();
