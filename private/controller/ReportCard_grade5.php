 ...
 * classes controller
 */
class ReportCard_grade5 extends Controller
{
	...
	public function index()
	{
		...
		$grade1s_ar = new Grade_5_arabicT1();
		$grade1s_en = new Grade_5_englishT1();
		$grade1s_sc = new Grade_5_scienceT1();
		$grade1s_re = new Grade_5_religionT1();
		$grade1s_ma = new Grade_5_mathT1();
