 ...
 * classes controller
 */
class ReportCard_grade11s extends Controller
{
	...
	public function index()
	{
		...
		$grade1s_ar = new Grade_11s_arabicT1();
		$grade1s_en = new Grade_11s_englishT1();
		$grade1s_bi = new Grade_11s_biologyT1();
		$grade1s_hi = new Grade_11s_historyT1();
		$grade1s_ma = new Grade_11s_mathT1();
		$grade1s_ph = new Grade_11s_physicsT1();
		$grade1s_ch = new Grade_11s_chemistryT1();
        $grade1s_ge = new Grade_11s_geoT1();
		$grade1s_ci = new Grade_11s_civT1();
        $grade1s_ec = new Grade_11s_ecoT1();
		$grade1s_so = new Grade_11s_socioT1();
        $grade1s_ph = new Grade_11s_philoT1();
